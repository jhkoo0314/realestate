...
def _cleanup_unused_fields(connection: sqlite3.Connection) -> None:
    ...
    try:
        ...
        CREATE TABLE consultation_activities_new (id INTEGER PRIMARY KEY AUTOINCREMENT, consultation_id INTEGER NOT NULL REFERENCES consultations(id) ON DELETE CASCADE, activity_date TEXT NOT NULL, activity_type TEXT NOT NULL, activity_note TEXT, stage_after_activity TEXT NOT NULL, visit_result TEXT, closed_reason TEXT, next_contact_date TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL);
        CREATE TABLE contract_activities_new (id INTEGER PRIMARY KEY AUTOINCREMENT, contract_id INTEGER NOT NULL REFERENCES contracts(id) ON DELETE CASCADE, activity_date TEXT NOT NULL, activity_stage TEXT NOT NULL, activity_note TEXT, contract_status_after TEXT NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL);
        """)
