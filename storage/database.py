...
def _ensure_compatibility_columns(connection: sqlite3.Connection) -> None:
    ...
    additions = {
        ...
        "consultations": (("consultation_category", "TEXT NOT NULL DEFAULT '매물 상담'"), ("desired_area", "TEXT"), ("desired_room_type", "TEXT"), ("desired_deposit_manwon", "INTEGER"), ("desired_monthly_rent_manwon", "INTEGER")),
    }
