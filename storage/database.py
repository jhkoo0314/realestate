...
def _ensure_compatibility_columns(connection: sqlite3.Connection) -> None:
    ...
    additions = {
        "listings": (("has_listing_photos", "TEXT NOT NULL DEFAULT '확인 필요'"), ("landlord_contact", "TEXT"), ("tenant_contact", "TEXT")),
        "contracts": (("contractor_contact", "TEXT"), ("contract_deposit_manwon", "INTEGER"), ("balance_manwon", "INTEGER")),
    }
