...
현재 **8단계: 건물·호실 상세 관리**까지 구현되어 있습니다.

- 매물 현황 리스트, 매물 등록·수정, 건물·호실 관리의 3개 메뉴
...
매물 회차에 연결한 일반·단기 계약의 기간·상태도 계약관리 탭에서 누적 관리할 수 있습니다.

아직 구현 예정인 기능은 백업·복구와 고객 이름·연락처를 포함한 간단한 상담 이력·다음 연락일 관리입니다.
